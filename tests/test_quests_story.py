...
class TestQuestModels:
    ...
    def test_quest_is_story_quest(self):
        q = Quest(id=4000, type="fetch", title="T", description="D",
                  giver_npc_id=1000, is_story_quest=True)
        assert q.is_story_quest is True

    def test_quest_room_id(self):
        q = Quest(id=4000, type="fetch", title="T", description="D",
                  giver_npc_id=1000, room_id="room_0")
        assert q.room_id == "room_0"

    def test_quest_time_gate(self):
        q = Quest(id=4000, type="fetch", title="T", description="D",
                  giver_npc_id=1000, time_gate="night")
...
class TestCombatQuest:
    def test_check_already_cleared(self):
        q = CombatQuest(id=4000, title="Kill", description="D",
                        giver_npc_id=1000, target_event_id=3000)
    ...
    def test_check_missing_event(self):
        q = CombatQuest(id=4000, title="Kill", description="D",
                        giver_npc_id=1000, target_event_id=3999)
...
class TestDialogueQuest:
    def test_cha_check_pass(self):
        player = _make_player()
        q = DialogueQuest(id=4000, title="Convince", description="D",
                          giver_npc_id=1000, dc=12)
...
class TestMultiStepQuest:
    def test_construction(self):
        q = MultiStepQuest(
            id=4003, title="Chain", description="D", giver_npc_id=1000,
...
class TestCreateQuestFromData:
    def test_create_fetch(self):
        q = create_quest_from_data({"id": 4000, "type": "fetch", "title": "T",
                                    "description": "D", "giver_npc_id": 1000})
        assert isinstance(q, FetchQuest)

    def test_create_multi_step(self):
        q = create_quest_from_data({
            "id": 4000, "type": "multi_step", "title": "T",
            "description": "D", "giver_npc_id": 1000,
    ...
    def test_create_dialogue_gated_alias(self):
        q = create_quest_from_data({
            "id": 4000, "type": "dialogue_gated", "title": "T",
            "description": "D", "giver_npc_id": 1000,
        })
...
class TestQuestValidation:
    ...
    def test_validate_combat_quest(self):
        ...
        npc_pool = [{"id": 1000, "selected": True}]
        event_list = [{"id": 3000}]
        quest = {"id": 4000, "type": "combat", "giver_npc_id": 1000,
                 "target_event_id": 3000}
    ...
    def test_validate_escort_quest(self):
        ...
        quest = {"id": 4000, "type": "escort", "giver_npc_id": 1000,
                 "escort_npc_id": 1001}
    ...
    def test_validate_delivery_quest(self):
        ...
        npc_pool = [{"id": 1000, "selected": True}, {"id": 1001, "selected": True}]
        item_placements = [{"item_id": 2000}]
        quest = {"id": 4000, "type": "delivery", "giver_npc_id": 1000,
                 "delivery_item_id": 2000, "target_npc_id": 1001}
    ...
    def test_validate_prerequisite_depth_limit(self):
        ...
        quest = {"id": 4003, "type": "fetch", "giver_npc_id": 1000,
                 "prerequisite_quest_id": 4002}
...
class TestQuestLog:
    ...
    def test_quest_log_active(self):
        qm = self._make_qm({
            4000: FetchQuest(id=4000, title="Get mushrooms", description="Find mushrooms",
                             giver_npc_id=1000, status="active"),
        })
        log = qm.get_quest_log()
    ...
    def test_quest_log_story_quest_flagged(self):
        qm = self._make_qm({
            4000: CombatQuest(id=4000, title="Purge cult", description="D",
                              giver_npc_id=1000, status="active",
                              is_story_quest=True, target_event_id=3000),
        })
        log = qm.get_quest_log()
    ...
    def test_quest_log_multi_step_progress(self):
        qm = self._make_qm({
            4003: MultiStepQuest(id=4003, title="Chain", description="D",
                                  giver_npc_id=1000, status="active",
                                  sub_quest_ids=[4000, 4001, 4002], current_step=1),
        })
        log = qm.get_quest_log()
        entry = log["active"][0]
    ...
    def test_quest_log_all_sections(self):
        qm = self._make_qm({
            4000: FetchQuest(id=4000, title="A", description="D",
                             giver_npc_id=1000, status="active"),
            4001: FetchQuest(id=4001, title="B", description="D",
                             giver_npc_id=1000, status="completed"),
            4002: FetchQuest(id=4002, title="C", description="D",
                             giver_npc_id=1000, status="failed"),
        })
        log = qm.get_quest_log()
        assert len(log["active"]) == 1
...
class TestQuestManager:
    ...
    def test_kill_quest_already_cleared_at_startup(self):
        ...
        q = CombatQuest(id=4000, title="Kill boss", description="D",
                        giver_npc_id=1000, target_event_id=3000,
                        status="not_started")
    ...
    def test_complete_quest_grants_money(self):
        q = FetchQuest(id=4000, title="T", description="D",
                       giver_npc_id=1000, status="active",
    ...
    def test_multi_step_advancement(self):
        sub1 = FetchQuest(id=4004, title="Step 1", description="D",
                          giver_npc_id=1000, status="active")
        sub2 = FetchQuest(id=4005, title="Step 2", description="D",
                          giver_npc_id=1000, status="not_started")
        parent = MultiStepQuest(id=4006, title="Chain", description="D",
                                giver_npc_id=1000, status="active",
                                sub_quest_ids=[4004, 4005])
    ...
    def test_try_offer_quest_with_prereq(self):
        q = FetchQuest(id=4001, title="T", description="D",
                       giver_npc_id=1000, status="not_started",
                       prerequisite_quest_id=4000)
    ...
    def test_check_room_quest_failures(self):
        q = FetchQuest(id=4000, title="Room task", description="D",
                       giver_npc_id=1000, status="active", room_id="room_1",
...
class TestFollowerManager:
    ...
    def test_follower_joins_via_escort(self):
        ...
        quest = EscortQuest(
            id=4007, title="Escort", description="D",
            giver_npc_id=1000, escort_npc_id=1200,
    ...
    def test_follower_leaves_on_room_progression(self):
        ...
        player = _make_player()
        q = Quest(id=4007, type="escort", title="Escort quest", description="D",
                  giver_npc_id=1000, status="active",
                  failure_penalty=QuestFailurePenalty(hp_damage=10))
        f = Follower(npc_id=1200, name="Elara", quest_id=4007,
    ...
    def test_get_follower_info(self):
        player = _make_player()
        q = Quest(id=4007, type="escort", title="Escort Guard", description="D",
                  giver_npc_id=1000)
        f = Follower(npc_id=1200, name="Guard", quest_id=4007,
